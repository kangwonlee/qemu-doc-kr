...
the <qemu-devel@nongnu.org> mailing list. All patches submitted must
contain a \'Signed-off-by\' line from the author. Patches should follow
the guidelines set out in the [style
...
Your patch series will be sent with \'v2\' tag in the subject and the
git tip will be tagged as my-feature-v2.
